...
public class Driver {
    /*
    Driver class'indan driver'i getDriver() methodu ile kullaniyoruz
    ...
    Bunun icin Driver class'inin parametsiz Const.'ini olusturup
    acsess modifier'ini PRIVATE yapmamiz gerekli.
     */
